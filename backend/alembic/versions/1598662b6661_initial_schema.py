...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('tenant_id', 'student_id', name='uq_borrowers_tenant_student_id')
    )
    ...
    op.create_index(op.f('ix_borrowers_tenant_id'), 'borrowers', ['tenant_id'], unique=False)
    op.create_index('ix_borrowers_tenant_name', 'borrowers', ['tenant_id', 'last_name', 'first_name'], unique=False)
    ...
    sa.ForeignKeyConstraint(['tenant_id'], ['tenants.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('tenant_id', 'barcode', name='uq_book_copies_tenant_barcode')
    )
    ...
    op.create_index(op.f('ix_book_copies_tenant_id'), 'book_copies', ['tenant_id'], unique=False)
    op.create_index('ix_book_copies_tenant_status', 'book_copies', ['tenant_id', 'status'], unique=False)
    ...
    op.create_index('ix_loans_tenant_due_date', 'loans', ['tenant_id', 'due_date'], unique=False)
    op.create_index(op.f('ix_loans_tenant_id'), 'loans', ['tenant_id'], unique=False)
    op.create_index('ix_loans_tenant_status', 'loans', ['tenant_id', 'status'], unique=False)
    ...
    op.create_index('ix_fines_tenant_status', 'fines', ['tenant_id', 'status'], unique=False)
