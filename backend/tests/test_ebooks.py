...
@pytest.mark.asyncio
async def test_create_ebook(async_client, librarian_headers):
    """POST /api/v1/ebooks → 200 with librarian auth."""
    payload = {
        "title": "Digital Book",
...
@pytest.mark.asyncio
async def test_get_ebook(async_client, librarian_headers):
...
@pytest.mark.asyncio
async def test_update_ebook(async_client, librarian_headers):
...
@pytest.mark.asyncio
async def test_delete_ebook(async_client, librarian_headers):
...
@pytest.mark.asyncio
async def test_search_ebooks(async_client, librarian_headers, auth_headers):
