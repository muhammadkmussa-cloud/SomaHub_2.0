...
const navItems: NavItem[] = [
  ...
  { label: 'Bookstore',   to: '/dashboard/bookstore',   icon: <ShoppingBag size={18} />,roles: ['reader', 'library_admin', 'super_admin'] },
  { label: 'My Library',  to: '/dashboard/my-library',  icon: <Library size={18} />,     roles: ['reader', 'library_admin', 'super_admin'] },
